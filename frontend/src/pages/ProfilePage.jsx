            ...
            <div className="container mt-5">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4 text-center">
                        <img
                            src={`${import.meta.env.VITE_BASE_URL}${userData?.profile_pic}`}
                            alt="Profile"
                    ...
                    <div className="col-md-8">
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-3">{userData?.dob}</div>
                        </div>
                        <div className="row mb-3">
                            <div className="col-sm-2 fw-bold">Biography:</div>
                            <div className="col-sm-3">{userData?.bio}</div>
                        </div>
                        <div className="row mb-3">
                            <div className="col-sm-2 fw-bold">Location:</div>
                            <div className="col-sm-3">{userData?.location}</div>
                        </div>
